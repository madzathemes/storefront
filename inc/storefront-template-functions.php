...
<div class="block footer-widget-1">
			<?php echo esc_html( apply_filters( 'storefront_copyright_text', $content = '&copy; ' . get_bloginfo( 'name' ) . ' ' . date( 'Y' ) ) ); ?>
							...
							<div class="block footer-widget-2 "><div class="paymentscardsimage lazy" data-original="<?php echo get_template_directory_uri(); ?>/assets/images/paymentcardsc.png"></div></div>
		</div><!-- .site-info -->
