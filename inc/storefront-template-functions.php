...
<div class="block footer-widget-1">
			<?php echo esc_html( apply_filters( 'storefront_copyright_text', $content = '&copy; ' . get_bloginfo( 'name' ) . ' ' . date( 'Y' ) ) ); ?>
							...
							<div class="block footer-widget-2 "><div class="paymentscardsimage"><img src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-lazy-type="image" data-src="<?php echo get_template_directory_uri(); ?>/assets/images/paymentcardsc.png"/></div></div>
		</div><!-- .site-info -->
...
if ( ! function_exists( 'storefront_smartmenu_button' ) ) {
	/**
	 * The Smart Button
	 */
	function storefront_smartmenu_button() {
		echo '<div class="storefront-smartmenu-button"></div>';
	}
}

if ( ! function_exists( 'storefront_currency_multi' ) ) {
	/**
	 * The Smart Button
	 */
	function storefront_currency_multi() {
		echo do_shortcode('[woo_multi_currency_layout5]');
	}
}

if ( ! function_exists( 'storefront_more_button' ) ) {
	/**
	 * The primary navigation wrapper
	 */
	function storefront_more_button() {
		echo '<div class="storefront-more-button"></div>';
	}
}
