...
add_action( 'storefront_header', 'storefront_product_search', 27 );
add_action( 'storefront_header', 'storefront_header_cart',    29 );
add_action( 'storefront_header', 'storefront_smartmenu_button',       43 );
add_action( 'storefront_header', 'storefront_primary_navigation_wrapper',       42 );
add_action( 'storefront_header', 'storefront_primary_navigation',               50 );
add_action( 'storefront_header', 'storefront_more_button',       51 );
add_action( 'storefront_header', 'storefront_currency_multi',       55 );
